...
function recalculate() {
  ...
  if (modelName === "XYZ") {
    ...
    throw new Error("Model Error: modelName holds invalid value."); 
  }
}
...
function changeModel() {
  const modelNameSpan = document.getElementById("model-text");
...
function changeDuration() {
  ...
  const newDuration = Number(prompt("Enter new duration"));
