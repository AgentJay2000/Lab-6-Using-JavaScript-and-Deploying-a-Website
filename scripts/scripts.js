...
function recalculate() {
    ...
    if (modelName === "XYZ") {
        ...
        throw new Error("Model Error: var modelName holds invalid value.");     
    }
}
...
function changeModel() {
    var modelNameSpan = document.getElementById("model-text");

    if (modelName === "XYZ") {
        modelName = "CPRG";
        modelNameSpan.textContent = "Model CPRG";
    } else if (modelName === "CPRG") {
        modelName = "XYZ";
        modelNameSpan.textContent = "Model XYZ";
    } else {
        throw new Error("Model Error: var modelName holds invalid value");
    }
...
function changeDuration() {
    var durationSpan = document.getElementById("duration-text");

    var newDuration = Number(prompt("Enter new duration"));
